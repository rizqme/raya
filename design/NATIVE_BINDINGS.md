...
**Status:** Implementation in Progress (Milestone 1.15)
...
- [design/MODULES.md](./MODULES.md) - Module system design
- [design/STDLIB.md](./STDLIB.md) - Standard library design

**See Also:**
- [design/ABI_SAFETY.md](./ABI_SAFETY.md) - **Thread safety & GC safety guarantees**
- [plans/milestone-1.15.md](../plans/milestone-1.15.md) - Implementation plan
- [design/MODULES.md](./MODULES.md) - Module system design
- [design/STDLIB.md](./STDLIB.md) - Standard library design
