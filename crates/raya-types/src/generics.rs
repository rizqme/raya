    ...
    pub fn apply_substitution(&mut self, ty: TypeId) -> Result<TypeId, TypeError> {
        ...
        match ty_data {
            ...
            Type::Generic(gen) => {
                ...
                let gen_ty = Type::Generic(crate::ty::GenericType { base, type_args });
    ...
    pub fn instantiate(
        ...
        match ty_data {
            ...
            Type::Reference(ref_ty) => {
                ...
                let new_ref = Type::Reference(crate::ty::TypeReference {
            ...
            Type::Generic(gen) => {
                ...
                let new_gen = Type::Generic(crate::ty::GenericType {
                    base: base_id,
                    type_args: new_args,
                });
