...
impl TypeContext {
    ...
    pub fn number_type(&mut self) -> TypeId {
        self.intern(Type::Primitive(crate::ty::PrimitiveType::Number))
    }

    /// Get the string type
    pub fn string_type(&mut self) -> TypeId {
        self.intern(Type::Primitive(crate::ty::PrimitiveType::String))
    }

    /// Get the boolean type
    pub fn boolean_type(&mut self) -> TypeId {
        self.intern(Type::Primitive(crate::ty::PrimitiveType::Boolean))
    }

    /// Get the null type
    pub fn null_type(&mut self) -> TypeId {
        self.intern(Type::Primitive(crate::ty::PrimitiveType::Null))
    }

    /// Get the void type
    pub fn void_type(&mut self) -> TypeId {
        self.intern(Type::Primitive(crate::ty::PrimitiveType::Void))
    }
    ...
    pub fn tuple_type(&mut self, elements: Vec<TypeId>) -> TypeId {
        self.intern(Type::Tuple(crate::ty::TupleType { elements }))
    }

    /// Create a function type
    pub fn function_type(&mut self, params: Vec<TypeId>, return_type: TypeId, is_async: bool) -> TypeId {
        self.intern(Type::Function(crate::ty::FunctionType {
            params,
            return_type,
            is_async,
        }))
