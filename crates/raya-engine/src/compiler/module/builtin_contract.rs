...
fn build_builtin_global_exports(
    ...
    for (name, descriptor) in crate::compiler::builtins::BuiltinRegistry::shared().global_descriptors()
    {
        provisional_symbols
            .entry(name.to_string())
            .or_insert(descriptor.symbol_type.clone());
    }
