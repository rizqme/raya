...
fn test_snapshot_magic_number_validation() {
    ...
    use raya_core::snapshot::format::ENDIANNESS_MARKER;
...
fn test_endianness_marker_in_snapshot() {
    use raya_core::snapshot::format::{ENDIANNESS_MARKER, ENDIANNESS_MARKER_SWAPPED};
...
fn test_snapshot_with_different_endianness_accepted() {
    use raya_core::snapshot::format::{SnapshotHeader, ENDIANNESS_MARKER_SWAPPED};
...
fn test_corrupted_endianness_marker_detected() {
    use raya_core::snapshot::format::SnapshotHeader;
...
fn test_byteswap_round_trip() {
    use raya_core::snapshot::format::byteswap;
...
fn test_safepoint_snapshot_coordination() {
    use raya_core::vm::{SafepointCoordinator, StopReason};
