...
use crate::object::{Array, Closure, Object, RayaString};
use crate::scheduler::{ExceptionHandler, Task, TaskId, TaskState};
use crate::stack::Stack;
use crate::value::Value;
use crate::vm::{ClassRegistry, SafepointCoordinator};
                        ...
                        match awaited_task.state() {
                            ...
                            TaskState::Failed => {
                                ...
                                if let Some(exc) = awaited_task.current_exception() {
                                    ...
                                    break; // Continue execution at new ip
                                } else {
                                    return Err(VmError::RuntimeError(format!(
                                        "Awaited task {:?} failed",
                                        awaited_task_id
