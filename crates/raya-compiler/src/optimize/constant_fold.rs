...
use crate::ir::{BasicBlock, BinaryOp, IrConstant, IrFunction, IrInstr, IrModule, IrValue, Register, RegisterId, UnaryOp};
...
mod tests {
    use super::*;
    use crate::ir::{BasicBlock, BasicBlockId, IrFunction, IrModule, Register, Terminator};
