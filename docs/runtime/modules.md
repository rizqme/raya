...
> **Status:** Implemented
> **Version:** 0.2
> **Related:** [Language Spec](../language/lang.md), [File Formats](../compiler/formats.md), [Stdlib](../stdlib/stdlib.md)
...
**Format:** Raya bytecode format (see [OPCODE.md](../compiler/opcode.md))
...
- See [REFLECTION.md](../metaprogramming/reflection.md) for details
...
See [DECORATORS.md](../metaprogramming/decorators.md) for decorator type system details.
...
See [DECORATORS.md](../metaprogramming/decorators.md) for decorator compilation details.
