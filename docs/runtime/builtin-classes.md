...
> **Status:** Implemented
> **Related:** [Language Spec](../language/lang.md), [Opcodes](../compiler/opcode.md), [Architecture](./architecture.md)
...
- [design/OPCODE.md](../compiler/opcode.md) - Bytecode instruction set
- [design/ARCHITECTURE.md](./architecture.md) - VM architecture
- [design/CHANNELS.md](../future/channels.md) - Channel design details
