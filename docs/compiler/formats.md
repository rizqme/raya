...
> **Status:** Implemented
> **Related:** [Opcodes](./opcode.md), [Modules](../runtime/modules.md), [CLI](../tooling/cli.md)
...
TypeScript-compatible syntax (strict subset). See [LANG.md](../language/lang.md) for complete language specification.
